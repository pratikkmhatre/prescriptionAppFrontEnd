!(function () {
  var e = {
              ...
              setTimeout(function () {
                ...
                R(l),
                  c && i
                    ...
                    : S({ event: t, properties: f, timestamp: s.zO() }),
                  i && D();
              })
            : w.push([t, n, i]);
        }
      ...
      84679: function (e, t, n) {
        ...
        var r,
          ...
          b = 6768134943,
          O = "production",
          E = "e38789078b9243e0841d6ae79feb20561358706c",
          w =
      ...
      21642: function (e, t, n) {
        "use strict";
        n(94656), n(36919), n(89489), n(23016);
      },
      3282: function (e, t, n) {
        "use strict";
        n.d(t, {
        ...
        var b = {
          ...
          call: function () {
            var e =
              ...
              h = this.options.url;
            h = _(h);
            var v = new ((null == p ? void 0 : p.XMLHttpRequest) || m)();
            this.setReq("ajax", v),
              v.open(i, h, !0),
              (v.onreadystatechange = function () {
                if (4 === v.readyState && v.status) {
                  var t,
                    u = a.Qc(v.responseText);
                  if (
                    (null !== (t = v.getResponseHeader("content-type")) &&
                      void 0 !== t &&
                      t.includes("text") &&
                      !u) ||
                    "string" == typeof u
            ...
            var y = (0, s.AP)("sessionId");
            y && (d["X-Razorpay-SessionId"] = y),
              a.VX(d, function (e, t) {
                return v.setRequestHeader(t, e);
              }),
              v.send(u);
          },
        };
  ...
  (n.n = function (e) {
    ...
    (function () {
      ...
      S.startsWith("https://api.razorpay.com") ||
        S.startsWith("https://api-dark.razorpay.com");
      var R = [];
      function D(e) {
        try {
      ...
      function F(e) {
        var t =
          ...
          i = t.onEmpty || K,
          a = t.onPause || K,
          c = U({ max: r, queue: n, interval: o, handler: e, onEmpty: i });
        return (
          n.length && c.schedule(),
          {
            flush: function () {
      ...
      function W(e, t, n) {
        ...
        Object.keys(r)
          ...
          "function" == typeof r &&
            ((null != e && e.loaded()) || n === x.INITIALIZE
              ? r(a, o)
              : (function (e, t, n, r) {
                  e.pendingQ ||
                    (e.pendingQ = F(
          ...
          function e(t) {
            ...
            var n = t.app,
              ...
              i = {
                ...
                platform: (0, Z.getDevice)(),
              };
            (this.flattenedContext = (0, V.xH)(i)),
              (this.userIdKey = "".concat(n, "_user_id")),
              (this.anonIdKey = "".concat(n, "_anon_id")),
              $.Z.getItem(this.anonIdKey) || this.setAnonymousId(J()),
              (this.state = {
                app: n,
                anonymousId: $.Z.getItem(this.anonIdKey) || "",
                userId: $.Z.getItem(this.userIdKey) || "",
                context: i,
                plugins: B(o),
                subscriptions: Object.keys(H).reduce(function (e, t) {
                  return (e[H[t]] = []), e;
                }, {}),
              }),
              W({}, this.state, x.INITIALIZE, {});
          }
          return (
            (0, L.Z)(e, [
              {
                key: "setAnonymousId",
                value: function (e) {
                  $.Z.setItem(this.anonIdKey, e),
                    this.state &&
                      ((this.state.anonymousId = e),
                      X(this.state.subscriptions, H.ANON_ID_UPDATED, e));
                },
              },
              {
                key: "setUserId",
                value: function (e) {
                  $.Z.setItem(this.userIdKey, e),
                    this.state &&
                      ((this.state.userId = e),
                      X(this.state.subscriptions, H.USER_ID_UPDATED, e));
                },
              },
              {
                key: "on",
              ...
              },
              {
                key: "reset",
                value: function () {
                  this.setAnonymousId(J()), this.setUserId("");
                },
              },
              {
                key: "getState",
      ...
      function pe(e) {
        try {
          var t = fe.Z.api;
          return (
            me.isIframe && (t = (0, le.resolveUrl)(fe.Z.frameApi)),
            t.startsWith(e)
          );
        } catch (e) {
          return !1;
      ...
      function ve() {
        return (
          ...
          !(function () {
            try {
              var e = me.isIframe ? document.referrer : window.location.href;
      ...
      var ye = pe(de.prod) || pe(de.dark),
        ...
        be = ye ? "2Fle0rY1hHoLCMetOdzYFs1RIJF" : "27TM2uVMCl4nm4d7gqR4tysvdU1",
        Oe = (function (e) {
          return (
        ...
        Ne = new ee({
          ...
          plugins: [
            ...
            Re(
              Re(
                {},
                ((De = { domainUrl: ge, key: be }),
                (Pe = De.domainUrl),
                (Te = De.key),
                (Ae = null),
                (Ie = !0),
                {
                  name: te.LUMBERJACK_PLUGIN,
                  initialize: function () {
                    (Ae = F(
                      function (e) {
                        try {
                      ...
                      window.addEventListener("beforeunload", function () {
                        var e;
                        (Ie = !0),
                          null === (e = Ae) || void 0 === e || e.flush(!0);
                      }),
                      window.addEventListener("offline", function () {
                        var e;
                        null === (e = Ae) || void 0 === e || e.pause();
                      }),
                      window.addEventListener("online", function () {
                        var e;
                        null === (e = Ae) || void 0 === e || e.resume();
                      });
                  },
                  pause: function () {
                    var e;
                  ...
                  track: function (e, t) {
                    var n, r;
                    null === (n = Ae) || void 0 === n || n.push(e),
                      t.isImmediate &&
                        (null === (r = Ae) || void 0 === r || r.flush());
                  },
                  identify: function (e) {
                    (function (e) {
                      var t = e.url,
                    ...
                    })({ url: Pe, key: Te, payload: e }).catch(ae);
                  },
                  loaded: function () {
                    return !0;
                  },
      ...
      j.Z.subscribe("syncContext", function (e) {
        var t, n;
        e.data && ((t = e.data.key), (n = e.data.value)),
          t && Ne.setContext(t, n);
      }),
        j.Z.subscribe("syncAnonymousId", function (e) {
          var t;
          null !== (t = e.data) &&
            void 0 !== t &&
            t.anonymousId &&
            Ne.setAnonymousId(e.data.anonymousId);
        }),
        j.Z.subscribe("syncUserId", function (e) {
          var t;
          null !== (t = e.data) &&
            void 0 !== t &&
            t.userId &&
            Ne.setUserId(e.data.userId);
        });
      var ke = Ne;
      function je(e, t) {
        var n = Object.keys(e);
                ...
                if (!n) {
                  var o = e[t],
                    i = (arguments.length <= 0 ? void 0 : arguments[0])
                      ? Ce(
                          Ce({}, arguments.length <= 0 ? void 0 : arguments[0]),
                          {},
                          { funnel: r }
                        )
                      : { funnel: r },
                  ...
                  if ("string" == typeof o) ke.track(o, i, a);
                    ...
                    o.type && (c = "".concat(o.type, " ").concat(c)),
                      o.type !== C.ERROR && (Me = { event: c, funnel: r }),
                      ke.track(c, i, a);
                  }
                }
              };
          ...
          setContext: function (e, t) {
            ...
            ke.setContext(e, t),
              n &&
                ...
                (function (e, t) {
                  me.isIframe
                    ? j.Z.publishToParent("syncContext", { key: e, value: t })
                    : j.Z.sendMessage("syncContext", { key: e, value: t });
                })(e, t);
          },
          getState: function () {
            return Ce(Ce({}, ke.getState()), {}, { last: Me });
          },
          Identify: ke.identify.bind(ke),
          Reset: ke.reset.bind(ke),
          configurePlugin: ke.configurePlugin.bind(ke),
          createTrackMethodForModule: Le,
        },
        Ze = (0, L.Z)(function e() {
          (0, M.Z)(this, e);
        });
      (0, y.Z)(Ze, "selectedBlock", {}),
        (0, y.Z)(Ze, "selectedInstrumentForPayment", {
          method: {},
          instrument: {},
        }),
        (0, y.Z)(Ze, "checkoutInvokedTime", Date.now()),
        (0, y.Z)(Ze, "personalisationVersionId", ""),
        (0, y.Z)(Ze, "submitScreenName", ""),
        (0, y.Z)(Ze, "cardFlow", ""),
        (0, y.Z)(Ze, "emiMode", ""),
        (0, y.Z)(Ze, "flow", ""),
        (0, y.Z)(Ze, "personalisationAPIType", ""),
        (0, y.Z)(Ze, "contactPrefillSource", ""),
        (0, y.Z)(Ze, "emailPrefillSource", ""),
        (0, y.Z)(Ze, "user_aggregates_available", !1),
        (0, y.Z)(Ze, "p13n_v3_reco_source", "");
      var Be = Le({ TRIGGERED: { name: "triggered", type: C.ERROR } });
      function Ke(e, t) {
        var n = Object.keys(e);
        if (Object.getOwnPropertySymbols) {
          var r = Object.getOwnPropertySymbols(e);
      ...
      var Fe = function (e, t) {
        ...
        try {
          var c,
            ...
            f = void 0 === m || m,
            d = !1;
          if (("razorpayjs" !== T.fQ.props.library && !ye) || Z.headlessChrome)
            return;
          (function (e) {
            try {
              var t = (0, A.HD)(e)
              ...
              return (
                I(
                  (0, A.HD)(e) ? e : (null == e ? void 0 : e.message) || "",
                  b,
                  !0
                ) ||
                I(t, _, !0) ||
          ...
          var h = (0, N.i)(e, { severity: o, unhandled: a, ignored: d });
          T.ZP.track(p, {
            data: Ue(
              Ue({}, "object" === (0, P.Z)(l) ? l : {}),
              {},
            ...
            Be.TRIGGERED({
              error: h,
              last:
                null === (c = xe.getState()) || void 0 === c ? void 0 : c.last,
            });
        } catch (e) {}
      };
      function He() {
              ...
              try {
                ...
                console.error &&
                  ...
                  (["TypeError", "ReferenceError"].indexOf(
                    ...
                    ? Fe(t, { severity: k.F.S1 })
                    : Fe(t, { severity: k.F.S2 }));
              }
            }),
            this
          );
      ...
      function Ve(e) {
        (e = (function (e) {
          ...
          (e = Ye(e, ze)).callback_url && Z.shouldRedirect && (e.redirect = !0),
          (this.get = function (t) {
      ...
      var $e = n(96120),
        Je = n(85235),
        Xe = n(74093),
        Qe = "customerAccessToken",
        qe = "standard_checkout";
      function et() {
        var t =
            arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "",
          r =
      ...
      function tt() {
        ...
        return et(
          n,
          t,
          ["checkoutjs", "hosted"].includes((0, Xe.AP)("library"))
        );
      }
      var nt = (0, e.vl)();
      function rt() {
        return (0, V.U2)(window, "webkit.messageHandlers.CheckoutBridge")
          ? { platform: "ios" }
          : {
              platform: nt.platform || "web",
              library: "checkoutjs",
              version: (nt.version || me.BUILD_NUMBER) + "",
            };
      }
      function ot(e, t) {
        var n = Object.keys(e);
      ...
      function at(e, t, n) {
        ...
        a && "".concat(c).length && i.push(a),
          (r.currency = i),
          me.optionsForPreferencesParams.forEach(function (e) {
            var n = t[e];
            n && (r[e] = n);
          }),
          "desktop" === (0, Z.getDevice)() && (r.qr_required = !0);
        var u,
          s =
            {
              "_[agent][platform]": rt().platform,
              "_[agent][device]":
                null != u && u.cred
                  ? "desktop" !== (0, Z.getDevice)()
                    ? "mobile"
                    : "desktop"
                  : (0, Z.getDevice)(),
              "_[agent][os]": (0, Z.getOS)(),
            } || {};
        return (r = it(it({}, r), s));
      }
      var ct = {
        ...
        lt = Le(ct, { funnel: we.HIGH_LEVEL }),
        mt =
          (Le(ut, { funnel: we.RETRY }),
          Le(st, { funnel: we.P13N_ALGO }),
          n(54041)),
        ft = (function () {
          function t(e) {
            var n = this;
      ...
      function dt(e) {
        var t,
          r = this;
        if (!A.is(this, dt)) return new dt(e);
        He.call(this),
          (this.id = T.fQ.makeUid()),
          xe.setContext(_e.CHECKOUT_ID, this.id),
          T.ZP.setR(this);
        try {
          (t = (function (e) {
            (e && "object" === (0, P.Z)(e)) || A.kz("Invalid options");
            var t = new Ve(e);
            return (
              (function (e) {
                var t =
        ...
        [
          ...
          me.BACKEND_ENTITIES_ID.every(function (e) {
            return !t.get(e);
          }) && A.kz("No key passed");
        try {
          T.fQ.props.library === me.RAZORPAYJS &&
            (T.ZP.track(me.CUSTOM_EVENTS.CUSTOM_CHECKOUT_INITIALISED, {
              data: { key: e.key },
            }),
            lt.CUSTOM_CHECKOUT_INITIALISED({ key: e.key }));
        } catch (e) {}
        $e.ZP.updateInstance(this), this.postInit();
      }
      (0, y.Z)(ft, "jsonp_cb", 0),
        (dt.sendMessage = function (e) {
          throw new Error("override missing for event - ".concat(e.event));
        });
      var pt = (dt.prototype = new He());
      (pt.postInit = ae),
        (pt.onNew = function (e, t) {
          var n,
            r,
            o,
            i = this;
            ...
            this.prefs
              ...
              : ((n = (function (e) {
                  if (e) {
                    var t = {};
                    (t.key = (0, $e.Rl)("key")),
                      (t.currency = (0, $e.Rl)("currency")),
                      (t.display_currency = (0, $e.Rl)("display_currency")),
                      (t.display_amount = (0, $e.Rl)("display_amount")),
                      (t.key = (0, $e.Rl)("key")),
                      me.optionsForPreferencesParams.forEach(function (e) {
                        var n = (0, $e.Rl)(e);
                        n && (t[e] = n);
                ...
                (o = {
                  url: tt(me.API.PREFERENCES),
                  data: n,
                  callback: function (e) {
                    ($e.ZP.preferenceResponse = e), r(e);
                  },
                }),
                new ft(o));
            try {
              T.zW.TrackMetric(me.CUSTOM_EVENTS.CUSTOM_CHECKOUT_PREFS, {
                key: this.get("key"),
              }),
                lt.CUSTOM_CHECKOUT_PREF({ key: this.get("key") });
            } catch (e) {}
          }
        }),
        (dt.emi = {
          ...
          amount: function (e, t) {
            ...
            if (
              ...
              return "should be passed in integer"
                ...
                .concat(o)
                .concat(i, ", i.e. ")
                .concat((0, Je.formatAmountWithSymbol)(o, n));
          },
          currency: function (e) {
            if (!Je.supportedCurrencies.includes(e))
              return "The provided currency is not currently supported";
          },
          display_currency: function (e) {
            if (
              !(e in Je.displayCurrencies) &&
              e !== dt.defaults.display_currency
            )
      ...
      (dt.configure = function (e) {
        var t =
          arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
        V.VX(Ye(e, ze), function (e, t) {
          var n = ze[t];
          (0, P.Z)(n) === (0, P.Z)(e) && (ze[t] = e);
        }),
          t.library &&
            ((T.fQ.props.library = t.library),
            (0, Xe.F$)("library", t.library),
            xe.setContext(_e.LIBRARY, t.library)),
          t.referer &&
            ((T.fQ.props.referer = t.referer),
            xe.setContext(_e.REFERRER, t.referer));
      }),
        (dt.defaults = ze),
        (dt.enableLite = Boolean(fe.Z.merchant_key || fe.Z.magic_shop_id)),
        (dt.setConfig = function () {
          var e =
              arguments.length > 0 && void 0 !== arguments[0]
                ? arguments[0]
                : "",
        ...
        (ze.modal = {
          ...
          animation:
            ...
            !(
              null !==
                (ht = n.g.matchMedia("(prefers-reduced-motion: reduce)")) &&
              void 0 !== ht &&
              ht.matches
            ),
          backdropclose: !1,
        ...
        (ze.external = { wallets: [], handler: ae }),
      ...
      var Et = function (e) {
        ...
        switch (e) {
          case "mWebAndroid":
            return "web" === t.platform && Z.android;
          case "mWebiOS":
            return "web" === t.platform && Z.iOS;
          case "androidSDK":
            return "android" === (null == t ? void 0 : t.platform);
          case "iosSDK":
            return "ios" === (null == t ? void 0 : t.platform);
          default:
            return (0, Z.isDesktop)();
        }
      };
      var wt = { "checkout.js": "checkout.js" };
      function St(e, t) {
        var n = Object.keys(e);
        if (Object.getOwnPropertySymbols) {
          var r = Object.getOwnPropertySymbols(e);
      ...
      var Tt,
        ...
        xt = {
          ...
          orientationchange: function () {
            xt.resize.call(this), xt.scroll.call(this);
          },
          resize: function () {
            var e = n.g.innerHeight || jt.height;
            (Ut.container.style.position = e < 450 ? "absolute" : "fixed"),
          ...
          scroll: function () {
            if ("number" == typeof n.g.pageYOffset)
              if (n.g.innerHeight < 460) {
                ...
                n.g.pageYOffset > e + 120 && (0, le.smoothScrollTo)(e);
              } else this.isFocused || (0, le.smoothScrollTo)(0);
          },
        };
      function Zt() {
        return (
          xt.metas ||
            (xt.metas = (0, le.querySelectorAll)(
      ...
      function Bt() {
        var n = fe.Z.frame || tt("checkout/public", !1),
          r = {
            traffic_env: me.TRAFFIC_ENV,
            build: me.COMMIT_HASH,
            modern: 1,
            unified_lite: 1,
          },
          o = t.LF;
      ...
      function Kt(e) {
        try {
          Ut.backdrop.style.background = e;
        } catch (e) {}
      }
      function Ut() {
        (Tt = document.body),
      ...
      Ut.prototype = {
        ...
        openRzp: function (e) {
          var t = ie.setStyles(this.el, { width: "100%", height: "100%" }),
            n = e.get("parent");
          n && (n = (0, le.resolveElement)(n));
          var r = n || Ut.container;
          Nt ||
            (Nt = (function () {
              var e,
                t =
              ...
              try {
                ...
                Fe(e, { severity: k.F.S3, unhandled: !1 });
              }
            })(r, n)),
            e !== this.rzp &&
              (ie.parent(t) !== r && ie.append(r, t), (this.rzp = e)),
            this.rzp &&
              setTimeout(function () {
                Lt || T.zW.Track(T.pz.FRAME_NOT_LOADED);
              }, 1e4),
            (function (e) {
              var t = (0, $e.Rl)("prefill.contact"),
                n = (0, $e.Rl)("prefill.email");
              t && xe.setContext(_e.TRAITS_CONTACT, t),
                n && xe.setContext(_e.TRAITS_EMAIL, n),
                (0, $e.NO)() && xe.setContext(_e.ORDER_ID, (0, $e.NO)()),
                e && xe.setContext(_e.MODE, e);
              var r = (0, $e.Rl)("_.integration");
              r && xe.setContext(_e.INTEGRATION_NAME, r);
              var o = (0, $e.Rl)("_.integration_version");
              o && xe.setContext(_e.INTEGRATION_VERSION, o);
              var i = Oe.INTEGRATION,
                a = Ee.WEB,
                c = (0, $e.Rl)("_.integration_type");
              c &&
                (c === Oe.RZP_APP
                  ? (i = Oe.RZP_APP)
                  : c === Ee.PLUGIN && (a = Ee.PLUGIN),
                xe.setContext(_e.INTEGRATION_TYPE, c)),
                xe.setContext(_e.REFERRER_TYPE, i);
              try {
                Et("androidSDK") ||
                  Et("iosSDK") ||
                  xe.setContext(_e.INTEGRATION_PLATFORM, a);
              } catch (e) {}
              var u = (0, $e.Rl)("_.integration_parent_version");
              u && xe.setContext(_e.INTEGRATION_PARENT_VERSION, u);
            })(this.rzp.getMode()),
            n
              ? (ie.setStyle(t, "minHeight", "530px"), (this.embedded = !0))
              : (ie.offsetWidth(ie.setStyle(r, "display", "block")),
                Kt(e.get("theme.backdrop_color")),
                /^rzp_t/.test(e.get("key")) &&
                  Ut.ribbon &&
                  (Ut.ribbon.style.opacity = 1),
        ...
        makeMessage: function (e, n) {
          ...
          var a = {
            ...
            referer: T.fQ.props.referer || window.location.href,
          ...
          return (
            ...
            n && (a.extra = n),
            V.VX(r.modal.options, function (e, t) {
              o["modal." + t] = e;
            }),
        ...
        close: function () {
          Kt(""),
            Ut.ribbon && (Ut.ribbon.style.opacity = 0),
            (function (e) {
              e && e.forEach(ie.detach);
              var t = Zt();
              t &&
                t.forEach(function (e) {
                  return ie.appendTo(e, At);
                });
            })(this.$metas),
            (It.overflow = xt.overflow),
            this.unbind(),
            Mt && Ct(0, xt.oldY),
            T.fQ.flush();
        },
        bind: function () {
          ...
          if (!this.listeners) {
            ...
            var t = {};
            Mt &&
              ((t.orientationchange = xt.orientationchange),
              this.rzp.get("parent") || (t.resize = xt.resize)),
              V.VX(t, function (t, n) {
                e.listeners.push(ie.on(n, t.bind(e))(window));
              });
          }
        },
        unbind: function () {
        ...
        setMetaAndOverflow: function () {
          At &&
            ...
            (xt.overflow = It.overflow),
            (It.overflow = "hidden"),
            Mt &&
              ((xt.oldY = n.g.pageYOffset),
              n.g.scrollTo(0, 0),
              xt.orientationchange.call(this)));
        },
        postMessage: function (e) {
          var t, n, r;
          e.id =
            (null === (t = this.rzp) || void 0 === t ? void 0 : t.id) || J();
        ...
        onload: function (e) {
          if (
            ...
            var t = this.makeMessage(),
              n = Boolean(
                V.s$(e) && "checkout-frame-standard-lite" === e.origin
              ),
              r = Boolean(V.s$(t) && t.options);
            if (n && !r) return;
            this.postMessage(t);
          }
        },
        ...
        onblur: function () {
          (this.isFocused = !1), xt.orientationchange.call(this);
        },
        onrender: function () {
          Nt && (ie.detach(Nt), (Nt = null)), this.rzp.emit("render");
        },
        onevent: function (e) {
        ...
        oncomplete: function (e) {
          ...
          var t = this.rzp,
            n = t.get("handler");
          T.ZP.track("checkout_success", { r: t, data: e, immediately: !0 }),
            A.mf(n) &&
              setTimeout(function () {
                n.call(t, e);
              }, 200);
        ...
        onpaymenterror: function (e) {
          ...
          try {
            var t,
              ...
              r = this.rzp.get("redirect") || Z.shouldRedirect,
        ...
        onfailure: function (e) {
          ...
          r && this.ongaevent({ event: _t, category: gt }),
            o && this.onfbaevent({ event: _t, category: gt }),
            this.ondismiss(),
        ...
        onfault: function (e) {
          ...
          (this.rzp.get("redirect") || Z.shouldRedirect) && r
            ? (0, bt.R2)({ url: r, params: { error: e }, method: "POST" })
            : n.g.alert("Oops! Something went wrong.\n" + t),
            this.afterClose();
        },
        afterClose: function () {
          Ut.container.style.display = "none";
        },
        onflush: function (e) {
          T.fQ.flush(e);
        },
      ...
      var zt,
        Gt = "is_one_click_checkout_enabled_lite",
        Yt = "abandoned_cart",
        Wt = n(90345),
        Vt = A.wH(dt);
      function $t(e) {
        return function t() {
          return zt ? e.call(this) : (setTimeout(t.bind(this), 99), this);
        };
      }
      !(function e() {
        (zt = document.body || document.getElementsByTagName("body")[0]) ||
          setTimeout(e, 99);
      })(),
        (function () {
          try {
            var e;
            (0, Xe.F$)("pauseTracking", !0);
            var t =
              null === (e = ke.getPluginState(te.LUMBERJACK_PLUGIN)) ||
              void 0 === e
                ? void 0
                : e.config;
            null == t || t.pause();
          } catch (e) {
            Fe("Pause Tracking Failed", { severity: k.F.S2 });
          }
        })(),
        (0, Xe.P_)(function (e, t) {
          try {
            if (t.pauseTracking && !e.pauseTracking) {
              var n,
                r =
                  null === (n = ke.getPluginState(te.LUMBERJACK_PLUGIN)) ||
                  void 0 === n
                    ? void 0
                    : n.config;
              null == r || r.resume();
            ...
            Fe(e, { severity: k.F.S2 });
          }
        });
      var Jt,
        Xt =
          document.currentScript ||
          (Jt = (0, le.querySelectorAll)("script"))[Jt.length - 1];
      function Qt(e) {
        var t = ie.parent(Xt);
        (0, bt.VG)({ form: t, data: (0, bt.xH)(e) }),
          (t.onsubmit = ae),
          t.submit();
      }
      var qt, en;
              ...
              ie.append(
                ...
                if (A.HD(r) && r && !a.callback_url) {
                  ...
                  try {
                    ...
                    a.callback_url = tt("checkout/onyx") + "?data=" + u;
                  } catch (e) {}
                }
                return (
      ...
      function nn() {
        if (!qt) {
          ...
          var t = (function (e) {
            ...
            return ie.setStyles(t, n), ie.appendTo(t, e);
          })(qt);
          Ut.backdrop = t;
          var n =
            ((r = t),
      ...
      function an() {
        if (!en) {
          var e;
          (en = new Ut()), (j.Z.iframeReference = en.el), j.Z.setId(T.fQ.id);
          var t = en.onmessage.bind(en);
          null === (e = ie.on("message", t)) || void 0 === e || e(n.g),
            ie.append(qt, en.el);
        }
        return en;
      }
      (0, Z.isBraveBrowser)().then(function (e) {
        rn = e;
      }),
        (0, Ft.r)()
          .then(function (e) {
        ...
        (dt.triggerShopifyCheckoutBtnClickEvent = function (e, t) {
          T.zW.setMeta(Wt.U.BRANDED_BTN_PAGE_TYPE, e || "unknown"),
            T.zW.TrackBehav("1cc_shopify_checkout_click", { btnType: t });
        }),
        (Vt.postInit = function () {
          var e = this;
          this.modal = { options: {} };
          var t = this.set;
      ...
      var cn = Vt.onNew;
      (Vt.onNew = function (e, t) {
        "payment.error" === e &&
          (0, T.fQ)(this, "event_paymenterror", window.location.href),
        ...
        (Vt.open = $t(function () {
            ...
            var e,
              ...
              r =
                ...
                void 0 === t
                  ? void 0
                  : t.getAttribute("lang");
            this.metadata = { isBrave: rn, isPrivate: on, language: r };
          }
          ...
          return (
            ...
            o.openRzp(this),
            T.zW.setMeta(Yt, (0, $e.p0)()),
            T.zW.setMeta(Gt, (0, $e.HU)() && !(0, $e.Rl)("order_id")),
            ...
            "-new.js" === Xt.src.slice(-7) &&
              (0, T.fQ)(this, "oldscript", window.location.href),
            this
          );
        })),
      ...
      var un = $t(function () {
          T.zW.setMeta(T.$J.IS_MOBILE, (0, Z.isMobile)()),
            nn(),
            window.Intl ? (en = an()) : T.zW.Track(T.pz.INTL_MISSING),
            j.Z.subscribe(Ht, function (e) {
              var t = (e.data || {}).url,
                n = Date.now(),
                r = window.onbeforeunload;
              window.onbeforeunload = null;
              try {
                (0, le.redirectTo)({ method: "GET", content: "", url: t });
              } catch (e) {}
              setTimeout(function () {
                j.Z.sendMessage("".concat(Ht, ":finished"), {
      ...
      var mn = "checkoutjs";
      (T.fQ.props.library = mn),
        (0, Xe.F$)("library", mn),
        xe.setContext(_e.LIBRARY, mn),
        xe.setContext(_e.VERSION, me.COMMIT_HASH),
        (ze.handler = function (e) {
          if (A.is(this, dt)) {
            var t = this.get("callback_url");
            t && (0, bt.R2)({ url: t, params: e, method: "POST" });
          }
        }),
        (ze.buttontext = "Pay Now"),
        (ze.parent = null);
      (vt.parent = function (e) {
        if (!(0, le.resolveElement)(e))
